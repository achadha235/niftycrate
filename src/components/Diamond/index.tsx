    ...
    <div className='wrap rotor-x'>
      ...
      <style jsx>{`
        ...
        .triangle.bottom.face-4 {
          ...
          transform: translateY(90px) rotateY(135deg) rotateX(35deg)
            scaleX(0.24) scaleY(-1);
        }
        .triangle.bottom.face-5 {
          animation-delay: -6500ms;
          transform: translateY(90px) rotateY(180deg) rotateX(35deg)
            scaleX(0.24) scaleY(-1);
        }
        .triangle.bottom.face-6 {
          animation-delay: -7500ms;
          transform: translateY(90px) rotateY(225deg) rotateX(35deg)
            scaleX(0.24) scaleY(-1);
        }
        .triangle.bottom.face-7 {
          animation-delay: -8500ms;
          transform: translateY(90px) rotateY(270deg) rotateX(35deg)
            scaleX(0.24) scaleY(-1);
        }
        .triangle.bottom.face-8 {
          animation-delay: -9500ms;
          transform: translateY(90px) rotateY(315deg) rotateX(35deg)
            scaleX(0.24) scaleY(-1);
        }
        ...
        .triangle.middle-bottom.face-1 {
          animation-delay: -3500ms;
          transform: rotateY(0deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-2 {
          animation-delay: -4500ms;
          transform: rotateY(45deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-3 {
          animation-delay: -5500ms;
          transform: rotateY(90deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-4 {
          animation-delay: -6500ms;
          transform: rotateY(135deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-5 {
          animation-delay: -7500ms;
          transform: rotateY(180deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-6 {
          animation-delay: -8500ms;
          transform: rotateY(225deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-7 {
          animation-delay: -9500ms;
          transform: rotateY(270deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        .triangle.middle-bottom.face-8 {
          animation-delay: -10500ms;
          transform: rotateY(315deg) translateY(-11px) translateZ(-34px)
            rotateX(-50deg) scaleX(0.24) scaleY(0.3);
        }
        ...
        .triangle.up.face-1 {
          animation-delay: -3500ms;
          transform: rotateY(22.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-2 {
          animation-delay: -4500ms;
          transform: rotateY(67.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-3 {
          animation-delay: -5500ms;
          transform: rotateY(112.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-4 {
          animation-delay: -6500ms;
          transform: rotateY(157.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-5 {
          animation-delay: -7500ms;
          transform: rotateY(202.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-6 {
          animation-delay: -8500ms;
          transform: rotateY(247.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-7 {
          animation-delay: -9500ms;
          transform: rotateY(292.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
        .triangle.up.face-8 {
          animation-delay: -10500ms;
          transform: rotateY(337.5deg) translateY(-22px) translateZ(0px)
            rotateX(-70deg) scaleX(0.13) scaleY(0.33);
        }
